...
public abstract class WorldActivator {
   ...
   public WorldActivator(Plot plot) {
      this.plot = plot;
   }

   public abstract WorldActivatorType getType();
   ...
   public void execute(GameEvent gameEvent, List<Entity> selectedEntities, int stackCounter, AtomicInteger callCounter) {
      this.selectedEntities = selectedEntities;
      WorldActivatorType.executeActions(this, gameEvent, this.getActionList(), stackCounter, callCounter);
   }
}
