...
public class PlayerProjectileDamageActivator extends Activator {
   public PlayerProjectileDamageActivator(Plot plot) {
      super(plot);
   }

   public ActivatorType getType() {
      return ActivatorType.PLAYER_PROJECTILE_DAMAGE;
   }

   public ItemData getIcon() {
      return new ItemData(Material.ARROW);
   }
   ...
   public static class Event extends GamePlayerEvent implements Cancellable, DamageEvent, EntityEvent {
      ...
      public Entity getShooter() {
         ProjectileSource shooter = ((Projectile)((EntityDamageCommonEvent)this.getHandleEvent()).getDamager()).getShooter();
