...
public class PlayerMobDamagePlayerActivator extends Activator {
   public PlayerMobDamagePlayerActivator(Plot plot) {
      super(plot);
   }

   public ActivatorType getType() {
      return ActivatorType.PLAYER_MOB_DAMAGE_PLAYER;
   }

   public ItemData getIcon() {
      return new ItemData(Material.WOOD_SWORD);
   }
