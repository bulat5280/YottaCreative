...
public class PlayerStopSprintActivator extends Activator {
   public PlayerStopSprintActivator(Plot plot) {
      super(plot);
   }

   public ActivatorType getType() {
      return ActivatorType.PLAYER_STOP_SPRINT;
   }

   public ItemData getIcon() {
      return new ItemData(Material.IRON_BOOTS);
   }
