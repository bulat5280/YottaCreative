...
public class PlayerRightClickActivator extends Activator {
   public PlayerRightClickActivator(Plot plot) {
      super(plot);
   }

   public ActivatorType getType() {
      return ActivatorType.PLAYER_RIGHT_CLICK;
   }

   public ItemData getIcon() {
      return new ItemData(Material.DIAMOND_PICKAXE);
   }

   public static class Event extends GamePlayerEvent implements Cancellable, ItemEvent, BlockEvent {
