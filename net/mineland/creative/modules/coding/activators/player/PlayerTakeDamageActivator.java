...
public class PlayerTakeDamageActivator extends Activator {
   public PlayerTakeDamageActivator(Plot plot) {
      super(plot);
   }

   public ActivatorType getType() {
      return ActivatorType.PLAYER_TAKE_DAMAGE;
   }

   public ItemData getIcon() {
      return new ItemData(Material.DEAD_BUSH);
   }
