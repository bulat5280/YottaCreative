...
public class ActionVarGetLocationX extends Action {
   public ActionVarGetLocationX(Activator activator) {
      super(activator);
   }

   public ActionType getType() {
      return ActionType.VARIABLE_GET_X;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.INK_SACK, 9);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      ...
      while(var5.hasNext()) {
         ...
         dynamicVariable.setValue(gameEvent.getPlot(), location.getX());
      }
