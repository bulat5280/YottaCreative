...
public class ActionVarGetLocationPitch extends Action {
   public ActionVarGetLocationPitch(Activator activator) {
      super(activator);
   }

   public ActionType getType() {
      return ActionType.VARIABLE_GET_PITCH;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.INK_SACK, 8);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      ...
      while(var5.hasNext()) {
         ...
         dynamicVariable.setValue(gameEvent.getPlot(), location.getPitch());
      }
