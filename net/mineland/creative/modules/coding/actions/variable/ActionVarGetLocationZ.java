...
public class ActionVarGetLocationZ extends Action {
   public ActionVarGetLocationZ(Activator activator) {
      super(activator);
   }

   public ActionType getType() {
      return ActionType.VARIABLE_GET_Z;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.INK_SACK, 13);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      ...
      while(var5.hasNext()) {
         ...
         dynamicVariable.setValue(gameEvent.getPlot(), location.getZ());
      }
