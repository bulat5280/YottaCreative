...
public class ActionVarGetLocationYaw extends Action {
   public ActionVarGetLocationYaw(Activator activator) {
      super(activator);
   }

   public ActionType getType() {
      return ActionType.VARIABLE_GET_YAW;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.INK_SACK, 10);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      ...
      while(var5.hasNext()) {
         ...
         dynamicVariable.setValue(gameEvent.getPlot(), location.getYaw());
      }
