...
public class ActionVarRemainder extends Action {
   public ActionVarRemainder(Activator activator) {
      super(activator);
   }

   public ActionType getType() {
      return ActionType.VARIABLE_REMAINDER;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.SMOOTH_BRICK);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      ...
      while(var5.hasNext()) {
         ...
         double dividend = (double)this.getVar("number_dividend", 0, gameEvent, selectedEntity);
         double divisor = (double)this.getVar("number_divisor", 0, gameEvent, selectedEntity);
   ...
   public boolean parseChest(ChestParser chestParser) {
      ...
      this.putVar("number_dividend", chestParser.getNumber(1));
      this.putVar("number_divisor", chestParser.getNumber(2));
      return true;
   }
}
