...
public class ActionIfVariableGreaterOrEqual extends ActionIf {
   public ActionIfVariableGreaterOrEqual(Activator activator) {
      super(activator);
   }
   ...
   public ActionType getType() {
      return ActionType.IF_VARIABLE_GREATER_OR_EQUAL;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.NETHER_BRICK_ITEM);
   }
