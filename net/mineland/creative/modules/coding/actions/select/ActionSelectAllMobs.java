...
public class ActionSelectAllMobs extends ActionSelect {
   public ActionSelectAllMobs(Activator activator) {
      super(activator);
   }
   ...
   public ActionType getType() {
      return ActionType.SELECT_ALL_MOBS;
   }

   public ItemData getIcon() {
      return new ItemData(Material.FERMENTED_SPIDER_EYE);
   }
}
