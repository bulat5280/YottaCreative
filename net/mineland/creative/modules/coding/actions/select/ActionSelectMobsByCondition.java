...
public class ActionSelectMobsByCondition extends ActionSelect {
   public ActionSelectMobsByCondition(Activator activator) {
      super(activator);
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.PUMPKIN_SEEDS);
   }
}
