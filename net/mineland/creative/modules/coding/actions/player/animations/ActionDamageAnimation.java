...
public class ActionDamageAnimation extends Action {
   public ActionDamageAnimation(Activator activator) {
      super(activator);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      selectedEntities.forEach((entity) -> {
         ...
         NMS.getManager().sendEntityAnimation(players, player, 1);
      });
      return true;
   }

   public ActionType getType() {
      return ActionType.PLAYER_DAMAGE_ANIMATION;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.REDSTONE_BLOCK);
   }
