...
public class ActionGetMagicCritAnimation extends Action {
   public ActionGetMagicCritAnimation(Activator activator) {
      super(activator);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      selectedEntities.forEach((entity) -> {
         ...
         NMS.getManager().sendEntityAnimation(players, player, 5);
      });
      return true;
   }

   public ActionType getType() {
      return ActionType.PLAYER_MAGIC_CRIT_ANIMATION;
   }
