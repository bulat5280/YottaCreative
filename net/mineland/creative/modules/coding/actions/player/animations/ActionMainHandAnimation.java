...
public class ActionMainHandAnimation extends Action {
   public ActionMainHandAnimation(Activator activator) {
      super(activator);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      selectedEntities.forEach((entity) -> {
         ...
         NMS.getManager().sendEntityAnimation(players, player, 0);
      });
      return true;
   }

   public ActionType getType() {
      return ActionType.PLAYER_MAIN_HAND_ANIMATION;
   }
