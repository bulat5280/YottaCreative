...
public class ActionOffHandAnimation extends Action {
   public ActionOffHandAnimation(Activator activator) {
      super(activator);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      selectedEntities.forEach((entity) -> {
         ...
         NMS.getManager().sendEntityAnimation(players, player, 3);
      });
      return true;
   }

   public ActionType getType() {
      return ActionType.PLAYER_OFF_HAND_ANIMATION;
   }
