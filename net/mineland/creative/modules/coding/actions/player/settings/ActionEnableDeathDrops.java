...
public class ActionEnableDeathDrops extends Action {
   public ActionEnableDeathDrops(Activator activator) {
      super(activator);
   }
   ...
   public boolean run(List<Entity> selectedEntities, GameEvent gameEvent, int stackCounter, AtomicInteger callCounter) {
      selectedEntities.forEach((entity) -> {
         ...
         user.removeMetadata("coding.save_inv");
      });
      return true;
   }
   ...
   public ItemData getIcon() {
      return new ItemData(Material.BEETROOT_SEEDS);
   }
