...
public class ActionIfGameContainerHasAllItems extends ActionIf {
   public ActionIfGameContainerHasAllItems(Activator activator) {
      super(activator);
   }
   ...
   public boolean expression(List<Entity> selectedEntities, GameEvent gameEvent) {
      ...
      while(var3.hasNext()) {
         ...
         for(int var10 = 0; var10 < var9; ++var10) {
            ...
            if (!ItemStackUtil.isNullOrAir(item) && !inventory.contains(item, item.getAmount())) {
               return false;
            }
         }
      }
   ...
   public ActionType getType() {
      return ActionType.IF_GAME_CONTAINER_HAS_ALL_ITEMS;
   }
