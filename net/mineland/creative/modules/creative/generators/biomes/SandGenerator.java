...
public class SandGenerator extends PlotGenerator {
   public SandGenerator(User user, Location pos) {
      super(user, pos);
   }

   void generate(EditSession editSession) {
      this.setBlocks(editSession, this.getCuboidRegion(3, 3), new ItemData(Material.SAND));
