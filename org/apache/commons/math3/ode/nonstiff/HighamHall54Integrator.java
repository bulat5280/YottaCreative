...
public class HighamHall54Integrator extends EmbeddedRungeKuttaIntegrator {
   ...
   private static final double[] STATIC_C = new double[]{0.2222222222222222D, 0.3333333333333333D, 0.5D, 0.6D, 1.0D, 1.0D};
   private static final double[][] STATIC_A = new double[][]{{0.2222222222222222D}, {0.08333333333333333D, 0.25D}, {0.125D, 0.0D, 0.375D}, {0.182D, -0.27D, 0.624D, 0.064D}, {-0.55D, 1.35D, 2.4D, -7.2D, 5.0D}, {0.08333333333333333D, 0.0D, 0.84375D, -1.3333333333333333D, 1.3020833333333333D, 0.10416666666666667D}};
   private static final double[] STATIC_B = new double[]{0.08333333333333333D, 0.0D, 0.84375D, -1.3333333333333333D, 1.3020833333333333D, 0.10416666666666667D, 0.0D};
   private static final double[] STATIC_E = new double[]{-0.05D, 0.0D, 0.50625D, -1.2D, 0.78125D, 0.0625D, -0.1D};
