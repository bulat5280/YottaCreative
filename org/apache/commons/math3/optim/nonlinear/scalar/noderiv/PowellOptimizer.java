...
public class PowellOptimizer extends MultivariateOptimizer {
   ...
   private class LineSearch extends BrentOptimizer {
      ...
      public UnivariatePointValuePair search(final double[] p, final double[] d) {
         ...
         return this.optimize(new OptimizationData[]{new MaxEval(Integer.MAX_VALUE), new UnivariateObjectiveFunction(f), goal, new SearchInterval(this.bracket.getLo(), this.bracket.getHi(), this.bracket.getMid())});
      }
   }
}
