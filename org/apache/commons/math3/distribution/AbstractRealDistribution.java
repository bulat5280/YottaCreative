            ...
            if (p == 1.0D) {
               ...
               if (lowerBound == Double.NEGATIVE_INFINITY) {
                  if (chebyshevApplies) {
                     ...
                     for(lowerBound = -1.0D; this.cumulativeProbability(lowerBound) >= p; lowerBound *= 2.0D) {
                     }
                  }
               }
               ...
               if (upperBound == Double.POSITIVE_INFINITY) {
                  if (chebyshevApplies) {
                     ...
                     for(upperBound = 1.0D; this.cumulativeProbability(upperBound) < p; upperBound *= 2.0D) {
                     }
                  }
               }
