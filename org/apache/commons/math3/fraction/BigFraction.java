...
public class BigFraction extends Number implements FieldElement<BigFraction>, Comparable<BigFraction>, Serializable {
   ...
   public double doubleValue() {
      ...
      if (Double.isNaN(result)) {
         int shift = Math.max(this.numerator.bitLength(), this.denominator.bitLength()) - FastMath.getExponent(Double.MAX_VALUE);
   ...
   public float floatValue() {
      ...
      if (Double.isNaN((double)result)) {
         int shift = Math.max(this.numerator.bitLength(), this.denominator.bitLength()) - FastMath.getExponent(Float.MAX_VALUE);
   ...
   public BigFraction multiply(BigFraction fraction) {
      if (fraction == null) {
         ...
         return !this.numerator.equals(BigInteger.ZERO) && !fraction.numerator.equals(BigInteger.ZERO) ? new BigFraction(this.numerator.multiply(fraction.numerator), this.denominator.multiply(fraction.denominator)) : ZERO;
      }
   }
