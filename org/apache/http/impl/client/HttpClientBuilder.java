...
public class HttpClientBuilder {
   ...
   public CloseableHttpClient build() {
      ...
      Object schemePortResolverCopy;
      if (routePlannerCopy == null) {
         schemePortResolverCopy = this.schemePortResolver;
      ...
      if (!this.redirectHandlingDisabled) {
         schemePortResolverCopy = this.redirectStrategy;
         if (schemePortResolverCopy == null) {
            schemePortResolverCopy = DefaultRedirectStrategy.INSTANCE;
         }

         execChain = new RedirectExec((ClientExecChain)execChain, (HttpRoutePlanner)routePlannerCopy, (RedirectStrategy)schemePortResolverCopy);
      }
      ...
      if (!this.connManagerShared) {
         ...
         if (this.evictExpiredConnections || this.evictIdleConnections) {
            final IdleConnectionEvictor connectionEvictor = new IdleConnectionEvictor((HttpClientConnectionManager)connManagerCopy, this.maxIdleTime > 0L ? this.maxIdleTime : 10L, this.maxIdleTimeUnit != null ? this.maxIdleTimeUnit : TimeUnit.SECONDS);
