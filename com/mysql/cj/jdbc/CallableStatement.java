...
public class CallableStatement extends PreparedStatement implements java.sql.CallableStatement {
   ...
   public CallableStatement(JdbcConnection conn, CallableStatement.CallableStatementParamInfo paramInfo) throws SQLException {
      ...
      this.noAccessToProcedureBodies = (Boolean)conn.getPropertySet().getBooleanReadableProperty("noAccessToProcedureBodies").getValue();
   }
   ...
   private void fakeParameterTypes(boolean isReallyProcedure) throws SQLException {
      try {
         synchronized(this.checkClosed().getConnectionMutex()) {
            ...
            ResultSet paramTypesRs = this.resultSetFactory.createFromResultsetRows(1007, 1004, new ResultsetRowsStatic(resultRows, new MysqlaColumnDefinition(fields)));
         ...
         synchronized(this.checkClosed().getConnectionMutex()) {
            ...
            try {
               ...
               try {
                  ...
                  AssertionFailedException.shouldNotHappen((Exception)var27);
               }
               ...
               paramTypesRs = dbmd.getProcedureColumns(useCatalog ? this.getCurrentCatalog() : tmpCatalog, (String)null, procName, "%");
         ...
         synchronized(this.checkClosed().getConnectionMutex()) {
            if (this.noAccessToProcedureBodies) {
               ...
               if (this.paramInfo == null) {
                  ...
                  CallableStatement.CallableStatementParam namedParamInfo = this.paramInfo.getParameter(paramName);
            ...
            if (numParameters > 0) {
               ...
               if (hadOutputParams) {
                  ...
                  try {
                     ...
                     this.outputParameterResults = ((ResultSetInternalMethods)outParamRs).copy(this.resultSetFactory);
      ...
      try {
         synchronized(this.checkClosed().getConnectionMutex()) {
            if (this.paramInfo.numParameters > 0) {
               ...
               while(true) {
                  CallableStatement.CallableStatementParam inParamInfo;
                  do {
                     do {
                        ...
                        inParamInfo = (CallableStatement.CallableStatementParam)paramIter.next();
                  ...
                  try {
                     setPstmt = (PreparedStatement)this.connection.clientPrepareStatement(queryBuf.toString()).unwrap(PreparedStatement.class);
   ...
   protected byte[] s2b(String s) {
      return s == null ? null : StringUtils.getBytes(s, (String)this.session.getPropertySet().getStringReadableProperty("characterEncoding").getValue());
   }
   ...
   public class CallableStatementParamInfo implements ParameterMetaData {
      ...
      public String getParameterClassName(int arg0) throws SQLException {
         try {
            ...
            switch(mysqlType) {
            case YEAR:
               if (!(Boolean)CallableStatement.this.session.getPropertySet().getBooleanReadableProperty("yearIsDateType").getValue()) {
