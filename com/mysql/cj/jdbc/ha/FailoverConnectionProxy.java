...
public class FailoverConnectionProxy extends MultiHostConnectionProxy {
   ...
   private FailoverConnectionProxy(ConnectionUrl connectionUrl) throws SQLException {
      ...
      this.secondsBeforeRetryPrimaryHost = (Integer)connProps.getIntegerReadableProperty("secondsBeforeRetryMaster").getValue();
      this.queriesBeforeRetryPrimaryHost = (long)(Integer)connProps.getIntegerReadableProperty("queriesBeforeRetryMaster").getValue();
      this.failoverReadOnly = (Boolean)connProps.getBooleanReadableProperty("failOverReadOnly").getValue();
      this.retriesAllDown = (Integer)connProps.getIntegerReadableProperty("retriesAllDown").getValue();
