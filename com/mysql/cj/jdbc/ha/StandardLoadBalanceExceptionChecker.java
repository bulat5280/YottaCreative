...
public class StandardLoadBalanceExceptionChecker implements LoadBalanceExceptionChecker {
   ...
   public void init(Properties props) {
      this.configureSQLStateList(props.getProperty("loadBalanceSQLStateFailover", (String)null));
      this.configureSQLExceptionSubclassList(props.getProperty("loadBalanceSQLExceptionSubclassFailover", (String)null));
   }
