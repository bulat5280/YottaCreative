...
public class PreparedStatementWrapper extends StatementWrapper implements java.sql.PreparedStatement {
   ...
   public void setRowId(int parameterIndex, RowId x) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setRowId(parameterIndex, x);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setNString(int parameterIndex, String value) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNString(parameterIndex, value);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setNCharacterStream(int parameterIndex, Reader value, long length) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNCharacterStream(parameterIndex, value, length);
      } catch (SQLException var6) {
         this.checkAndFireConnectionError(var6);
      }
   ...
   public void setNClob(int parameterIndex, java.sql.NClob value) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNClob(parameterIndex, value);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setClob(int parameterIndex, Reader reader, long length) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setClob(parameterIndex, reader, length);
      } catch (SQLException var6) {
         this.checkAndFireConnectionError(var6);
      }
   ...
   public void setBlob(int parameterIndex, InputStream inputStream, long length) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setBlob(parameterIndex, inputStream, length);
      } catch (SQLException var6) {
         this.checkAndFireConnectionError(var6);
      }
   ...
   public void setNClob(int parameterIndex, Reader reader, long length) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNClob(parameterIndex, reader, length);
      } catch (SQLException var6) {
         this.checkAndFireConnectionError(var6);
      }
   ...
   public void setSQLXML(int parameterIndex, SQLXML xmlObject) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setSQLXML(parameterIndex, xmlObject);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setAsciiStream(int parameterIndex, InputStream x) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setAsciiStream(parameterIndex, x);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setBinaryStream(int parameterIndex, InputStream x) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setBinaryStream(parameterIndex, x);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setCharacterStream(int parameterIndex, Reader reader) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setCharacterStream(parameterIndex, reader);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setNCharacterStream(int parameterIndex, Reader value) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNCharacterStream(parameterIndex, value);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setClob(int parameterIndex, Reader reader) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setClob(parameterIndex, reader);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setBlob(int parameterIndex, InputStream inputStream) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setBlob(parameterIndex, inputStream);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setNClob(int parameterIndex, Reader reader) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setNClob(parameterIndex, reader);
      } catch (SQLException var4) {
         this.checkAndFireConnectionError(var4);
      }
   ...
   public void setObject(int parameterIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException {
      try {
         ...
         ((java.sql.PreparedStatement)this.wrappedStmt).setObject(parameterIndex, x, targetSqlType, scaleOrLength);
      } catch (SQLException var6) {
         this.checkAndFireConnectionError(var6);
      }
