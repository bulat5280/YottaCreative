...
public class BlobFromLocator implements java.sql.Blob {
   ...
   public InputStream getBinaryStream() throws SQLException {
      try {
         return new BufferedInputStream(new BlobFromLocator.LocatorInputStream(), (Integer)this.creatorResultSet.getConnection().getPropertySet().getMemorySizeReadableProperty("locatorFetchBufferSize").getValue());
   ...
   byte[] getBytesInternal(java.sql.PreparedStatement pStmt, long pos, int length) throws SQLException {
      ...
      try {
         ...
         var15 = ((ResultSetImpl)blobRs).getBytes(1);
      } finally {
         if (blobRs != null) {
            try {
               blobRs.close();
