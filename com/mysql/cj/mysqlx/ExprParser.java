...
public class ExprParser {
   ...
   MysqlxExpr.Expr ilriExpr() {
      ...
      List expected = Arrays.asList(ExprParser.TokenType.IS, ExprParser.TokenType.IN, ExprParser.TokenType.LIKE, ExprParser.TokenType.BETWEEN, ExprParser.TokenType.REGEXP, ExprParser.TokenType.NOT);
