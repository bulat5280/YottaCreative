...
public final class MysqlxExpect {
   private static final Descriptor internal_static_Mysqlx_Expect_Open_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Expect_Open_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Expect_Open_Condition_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Expect_Open_Condition_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Expect_Close_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Expect_Close_fieldAccessorTable;
   ...
   static {
      String[] descriptorData = new String[]{"\n\u0013mysqlx_expect.proto\u0012\rMysqlx.Expect\"\u0080\u0003\n\u0004Open\u0012B\n\u0002op\u0018\u0001 \u0001(\u000e2 .Mysqlx.Expect.Open.CtxOperation:\u0014EXPECT_CTX_COPY_PREV\u0012+\n\u0004cond\u0018\u0002 \u0003(\u000b2\u001d.Mysqlx.Expect.Open.Condition\u001aÆ\u0001\n\tCondition\u0012\u0015\n\rcondition_key\u0018\u0001 \u0002(\r\u0012\u0017\n\u000fcondition_value\u0018\u0002 \u0001(\f\u0012K\n\u0002op\u0018\u0003 \u0001(\u000e20.Mysqlx.Expect.Open.Condition.ConditionOperation:\rEXPECT_OP_SET\"<\n\u0012ConditionOperation\u0012\u0011\n\rEXPECT_OP_SET\u0010\u0000\u0012\u0013\n\u000fEXPECT_OP_UNSET\u0010\u0001\">\n\fCtxOperation\u0012\u0018\n\u0014EXPECT_CTX_COPY_PREV\u0010", "\u0000\u0012\u0014\n\u0010EXPECT_CTX_EMPTY\u0010\u0001\"\u0007\n\u0005CloseB\u001e\n\u001ccom.mysql.cj.mysqlx.protobuf"};
      ...
      internal_static_Mysqlx_Expect_Open_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(0);
      internal_static_Mysqlx_Expect_Open_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Expect_Open_descriptor, new String[]{"Op", "Cond"});
      internal_static_Mysqlx_Expect_Open_Condition_descriptor = (Descriptor)internal_static_Mysqlx_Expect_Open_descriptor.getNestedTypes().get(0);
      internal_static_Mysqlx_Expect_Open_Condition_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Expect_Open_Condition_descriptor, new String[]{"ConditionKey", "ConditionValue", "Op"});
      internal_static_Mysqlx_Expect_Close_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(1);
      internal_static_Mysqlx_Expect_Close_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Expect_Close_descriptor, new String[0]);
   }
   ...
   public static final class Close extends GeneratedMessage implements MysqlxExpect.CloseOrBuilder {
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxExpect.Close.Builder> implements MysqlxExpect.CloseOrBuilder {
         public static final Descriptor getDescriptor() {
            return MysqlxExpect.internal_static_Mysqlx_Expect_Close_descriptor;
         }
   ...
   public static final class Open extends GeneratedMessage implements MysqlxExpect.OpenOrBuilder {
      ...
      // $FF: synthetic method
      Open(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Condition extends GeneratedMessage implements MysqlxExpect.Open.ConditionOrBuilder {
         ...
         // $FF: synthetic method
         Condition(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
            this(x0);
         }
         ...
         public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxExpect.Open.Condition.Builder> implements MysqlxExpect.Open.ConditionOrBuilder {
            private int bitField0_;
            private int conditionKey_;
            private ByteString conditionValue_;
            private MysqlxExpect.Open.Condition.ConditionOperation op_;
