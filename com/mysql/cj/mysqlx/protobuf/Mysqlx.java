...
public final class Mysqlx {
   private static final Descriptor internal_static_Mysqlx_ClientMessages_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_ClientMessages_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_ServerMessages_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_ServerMessages_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Ok_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Ok_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Error_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Error_fieldAccessorTable;
   ...
   static {
      ...
      FileDescriptor.internalBuildGeneratedFileFrom(descriptorData, new FileDescriptor[]{MysqlxSql.getDescriptor(), MysqlxResultset.getDescriptor(), MysqlxCrud.getDescriptor(), MysqlxSession.getDescriptor(), MysqlxConnection.getDescriptor(), MysqlxExpect.getDescriptor(), MysqlxNotice.getDescriptor()}, assigner);
      internal_static_Mysqlx_ClientMessages_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(0);
      internal_static_Mysqlx_ClientMessages_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_ClientMessages_descriptor, new String[0]);
      internal_static_Mysqlx_ServerMessages_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(1);
      internal_static_Mysqlx_ServerMessages_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_ServerMessages_descriptor, new String[0]);
      internal_static_Mysqlx_Ok_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(2);
      internal_static_Mysqlx_Ok_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Ok_descriptor, new String[]{"Msg"});
      internal_static_Mysqlx_Error_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(3);
      internal_static_Mysqlx_Error_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Error_descriptor, new String[]{"Severity", "Code", "SqlState", "Msg"});
      MysqlxSql.getDescriptor();
      MysqlxResultset.getDescriptor();
      MysqlxCrud.getDescriptor();
      MysqlxSession.getDescriptor();
      MysqlxConnection.getDescriptor();
      MysqlxExpect.getDescriptor();
      MysqlxNotice.getDescriptor();
   }
   ...
   public static final class Error extends GeneratedMessage implements Mysqlx.ErrorOrBuilder {
      ...
      // $FF: synthetic method
      Error(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
   ...
   public static final class Ok extends GeneratedMessage implements Mysqlx.OkOrBuilder {
      ...
      // $FF: synthetic method
      Ok(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
   ...
   public static final class ServerMessages extends GeneratedMessage implements Mysqlx.ServerMessagesOrBuilder {
      ...
      // $FF: synthetic method
      ServerMessages(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Mysqlx.ServerMessages.Builder> implements Mysqlx.ServerMessagesOrBuilder {
         public static final Descriptor getDescriptor() {
            return Mysqlx.internal_static_Mysqlx_ServerMessages_descriptor;
         }
   ...
   public static final class ClientMessages extends GeneratedMessage implements Mysqlx.ClientMessagesOrBuilder {
      ...
      // $FF: synthetic method
      ClientMessages(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Mysqlx.ClientMessages.Builder> implements Mysqlx.ClientMessagesOrBuilder {
         public static final Descriptor getDescriptor() {
            return Mysqlx.internal_static_Mysqlx_ClientMessages_descriptor;
         }
