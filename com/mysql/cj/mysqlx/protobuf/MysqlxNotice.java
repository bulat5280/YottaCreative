...
public final class MysqlxNotice {
   private static final Descriptor internal_static_Mysqlx_Notice_Frame_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Notice_Frame_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Notice_Warning_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Notice_Warning_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Notice_SessionVariableChanged_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Notice_SessionVariableChanged_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Notice_SessionStateChanged_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Notice_SessionStateChanged_fieldAccessorTable;
   ...
   static {
      ...
      internal_static_Mysqlx_Notice_Frame_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(0);
      internal_static_Mysqlx_Notice_Frame_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Notice_Frame_descriptor, new String[]{"Type", "Scope", "Payload"});
      internal_static_Mysqlx_Notice_Warning_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(1);
      internal_static_Mysqlx_Notice_Warning_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Notice_Warning_descriptor, new String[]{"Level", "Code", "Msg"});
      internal_static_Mysqlx_Notice_SessionVariableChanged_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(2);
      internal_static_Mysqlx_Notice_SessionVariableChanged_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Notice_SessionVariableChanged_descriptor, new String[]{"Param", "Value"});
      internal_static_Mysqlx_Notice_SessionStateChanged_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(3);
      internal_static_Mysqlx_Notice_SessionStateChanged_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Notice_SessionStateChanged_descriptor, new String[]{"Param", "Value"});
   ...
   public static final class SessionStateChanged extends GeneratedMessage implements MysqlxNotice.SessionStateChangedOrBuilder {
      ...
      // $FF: synthetic method
      SessionStateChanged(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxNotice.SessionStateChanged.Builder> implements MysqlxNotice.SessionStateChangedOrBuilder {
         private int bitField0_;
         private MysqlxNotice.SessionStateChanged.Parameter param_;
         private MysqlxDatatypes.Scalar value_;
         ...
         public MysqlxNotice.SessionStateChanged.Builder setValue(MysqlxDatatypes.Scalar value) {
            if (this.valueBuilder_ == null) {
               if (value == null) {
                  throw new NullPointerException();
               }
         ...
         public MysqlxNotice.SessionStateChanged.Builder setValue(MysqlxDatatypes.Scalar.Builder builderForValue) {
            if (this.valueBuilder_ == null) {
         ...
         public MysqlxNotice.SessionStateChanged.Builder mergeValue(MysqlxDatatypes.Scalar value) {
            if (this.valueBuilder_ == null) {
         ...
         public MysqlxDatatypes.ScalarOrBuilder getValueOrBuilder() {
            return (MysqlxDatatypes.ScalarOrBuilder)(this.valueBuilder_ != null ? (MysqlxDatatypes.ScalarOrBuilder)this.valueBuilder_.getMessageOrBuilder() : this.value_);
         }
   ...
   public static final class SessionVariableChanged extends GeneratedMessage implements MysqlxNotice.SessionVariableChangedOrBuilder {
      ...
      // $FF: synthetic method
      SessionVariableChanged(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxNotice.SessionVariableChanged.Builder> implements MysqlxNotice.SessionVariableChangedOrBuilder {
         private int bitField0_;
         private Object param_;
         private MysqlxDatatypes.Scalar value_;
         private SingleFieldBuilder<MysqlxDatatypes.Scalar, MysqlxDatatypes.Scalar.Builder, MysqlxDatatypes.ScalarOrBuilder> valueBuilder_;
   ...
   public static final class Warning extends GeneratedMessage implements MysqlxNotice.WarningOrBuilder {
      ...
      // $FF: synthetic method
      Warning(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxNotice.Warning.Builder> implements MysqlxNotice.WarningOrBuilder {
         private int bitField0_;
         private MysqlxNotice.Warning.Level level_;
         private int code_;
         private Object msg_;
   ...
   public static final class Frame extends GeneratedMessage implements MysqlxNotice.FrameOrBuilder {
      ...
      // $FF: synthetic method
      Frame(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxNotice.Frame.Builder> implements MysqlxNotice.FrameOrBuilder {
         private int bitField0_;
         private int type_;
         private MysqlxNotice.Frame.Scope scope_;
         private ByteString payload_;
