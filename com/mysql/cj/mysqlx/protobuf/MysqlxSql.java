...
public final class MysqlxSql {
   private static final Descriptor internal_static_Mysqlx_Sql_StmtExecute_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Sql_StmtExecute_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Sql_StmtExecuteOk_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Sql_StmtExecuteOk_fieldAccessorTable;
   ...
   static {
      ...
      internal_static_Mysqlx_Sql_StmtExecute_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(0);
      internal_static_Mysqlx_Sql_StmtExecute_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Sql_StmtExecute_descriptor, new String[]{"Namespace", "Stmt", "Args", "CompactMetadata"});
      internal_static_Mysqlx_Sql_StmtExecuteOk_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(1);
      internal_static_Mysqlx_Sql_StmtExecuteOk_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Sql_StmtExecuteOk_descriptor, new String[0]);
   ...
   public static final class StmtExecuteOk extends GeneratedMessage implements MysqlxSql.StmtExecuteOkOrBuilder {
      ...
      // $FF: synthetic method
      StmtExecuteOk(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxSql.StmtExecuteOk.Builder> implements MysqlxSql.StmtExecuteOkOrBuilder {
         public static final Descriptor getDescriptor() {
            return MysqlxSql.internal_static_Mysqlx_Sql_StmtExecuteOk_descriptor;
         }
   ...
   public static final class StmtExecute extends GeneratedMessage implements MysqlxSql.StmtExecuteOrBuilder {
      ...
      // $FF: synthetic method
      StmtExecute(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxSql.StmtExecute.Builder> implements MysqlxSql.StmtExecuteOrBuilder {
         private int bitField0_;
         private Object namespace_;
         private ByteString stmt_;
         private List<MysqlxDatatypes.Any> args_;
