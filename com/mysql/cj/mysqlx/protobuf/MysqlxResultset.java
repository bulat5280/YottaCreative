...
public final class MysqlxResultset {
   private static final Descriptor internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Resultset_FetchDone_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Resultset_FetchDone_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Resultset_ColumnMetaData_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Resultset_ColumnMetaData_fieldAccessorTable;
   private static final Descriptor internal_static_Mysqlx_Resultset_Row_descriptor;
   private static FieldAccessorTable internal_static_Mysqlx_Resultset_Row_fieldAccessorTable;
   ...
   static {
      ...
      internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(0);
      internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_descriptor, new String[0]);
      internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(1);
      internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_descriptor, new String[0]);
      internal_static_Mysqlx_Resultset_FetchDone_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(2);
      internal_static_Mysqlx_Resultset_FetchDone_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Resultset_FetchDone_descriptor, new String[0]);
      internal_static_Mysqlx_Resultset_ColumnMetaData_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(3);
      internal_static_Mysqlx_Resultset_ColumnMetaData_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Resultset_ColumnMetaData_descriptor, new String[]{"Type", "Name", "OriginalName", "Table", "OriginalTable", "Schema", "Catalog", "Collation", "FractionalDigits", "Length", "Flags", "ContentType"});
      internal_static_Mysqlx_Resultset_Row_descriptor = (Descriptor)getDescriptor().getMessageTypes().get(4);
      internal_static_Mysqlx_Resultset_Row_fieldAccessorTable = new FieldAccessorTable(internal_static_Mysqlx_Resultset_Row_descriptor, new String[]{"Field"});
   }
   ...
   public static final class Row extends GeneratedMessage implements MysqlxResultset.RowOrBuilder {
      ...
      // $FF: synthetic method
      Row(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxResultset.Row.Builder> implements MysqlxResultset.RowOrBuilder {
   ...
   public static final class ColumnMetaData extends GeneratedMessage implements MysqlxResultset.ColumnMetaDataOrBuilder {
      ...
      // $FF: synthetic method
      ColumnMetaData(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxResultset.ColumnMetaData.Builder> implements MysqlxResultset.ColumnMetaDataOrBuilder {
         private int bitField0_;
         private MysqlxResultset.ColumnMetaData.FieldType type_;
         private ByteString name_;
         private ByteString originalName_;
   ...
   public static final class FetchDone extends GeneratedMessage implements MysqlxResultset.FetchDoneOrBuilder {
      ...
      // $FF: synthetic method
      FetchDone(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxResultset.FetchDone.Builder> implements MysqlxResultset.FetchDoneOrBuilder {
         public static final Descriptor getDescriptor() {
            return MysqlxResultset.internal_static_Mysqlx_Resultset_FetchDone_descriptor;
         }
   ...
   public static final class FetchDoneMoreResultsets extends GeneratedMessage implements MysqlxResultset.FetchDoneMoreResultsetsOrBuilder {
      ...
      // $FF: synthetic method
      FetchDoneMoreResultsets(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxResultset.FetchDoneMoreResultsets.Builder> implements MysqlxResultset.FetchDoneMoreResultsetsOrBuilder {
         public static final Descriptor getDescriptor() {
            return MysqlxResultset.internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_descriptor;
         }
         ...
         public MysqlxResultset.FetchDoneMoreResultsets.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
               parsedMessage = (MysqlxResultset.FetchDoneMoreResultsets)MysqlxResultset.FetchDoneMoreResultsets.PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (InvalidProtocolBufferException var8) {
   ...
   public static final class FetchDoneMoreOutParams extends GeneratedMessage implements MysqlxResultset.FetchDoneMoreOutParamsOrBuilder {
      ...
      // $FF: synthetic method
      FetchDoneMoreOutParams(com.google.protobuf.GeneratedMessage.Builder x0, Object x1) {
         this(x0);
      }
      ...
      public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<MysqlxResultset.FetchDoneMoreOutParams.Builder> implements MysqlxResultset.FetchDoneMoreOutParamsOrBuilder {
         public static final Descriptor getDescriptor() {
            return MysqlxResultset.internal_static_Mysqlx_Resultset_FetchDoneMoreOutParams_descriptor;
         }
         ...
         public MysqlxResultset.FetchDoneMoreOutParams.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
               parsedMessage = (MysqlxResultset.FetchDoneMoreOutParams)MysqlxResultset.FetchDoneMoreOutParams.PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (InvalidProtocolBufferException var8) {
