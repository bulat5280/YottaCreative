...
public class Jdk14Logger implements Log {
   ...
   private static final int findCallerStackDepth(StackTraceElement[] stackTrace) {
      ...
      for(int i = 0; i < numFrames; ++i) {
         ...
         if (!callerClassName.startsWith("com.mysql.cj.api") && !callerClassName.startsWith("com.mysql.cj.core") && !callerClassName.startsWith("com.mysql.cj.api.jdbc") && !callerClassName.startsWith("com.mysql.cj.jdbc")) {
            return i;
         }
      }
