...
public class ProfilerEventImpl implements ProfilerEvent {
   ...
   public static ProfilerEvent unpack(byte[] buf) {
      ...
      return new ProfilerEventImpl(eventType, "", "", connectionId, statementId, resultSetId, eventCreationTime, eventDuration, StringUtils.toString(eventDurationUnits, "ISO8859_1"), StringUtils.toString(eventCreationAsBytes, "ISO8859_1"), (String)null, StringUtils.toString(message, "ISO8859_1"));
   }
   ...
   public byte[] pack() {
      ...
      if (this.eventCreationPointDesc != null) {
         ...
         len = len + 4 + eventCreationAsBytes.length;
      } else {
         len = len + 4;
      }
      ...
      byte var10001 = pos;
      int pos = pos + 1;
      buf[var10001] = this.getEventType();
